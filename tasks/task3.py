...
if __name__ == '__main__':
    ...
    print(newton_method_for_nonlinear_system([x, y], system, boundaries=segment2, error=error))
    print(newton_method_for_nonlinear_system([x, y], system, boundaries=segment1, error=error))
